...
class PostRepositoryTest extends KernelTestCase
{
    ...
    public function testFindByPage()
    {
        ...
        $this->assertEquals(8561754, $posts[97]->getId());
        $this->assertEquals("Aujourd'hui, je travaille dans un garage. Un client est arrivé, m'a tendu une photo de voiture hyper customisée de GTA V et m'a dit que j'avais une semaine pour la rendre comme ça. La voiture de la photo est une Porsche et sa voiture est une Peugeot. VDM", $posts[97]->getContent());
        $this->assertEquals('charles2cb', $posts[97]->getAuthor());
        $this->assertEquals('2015-06-03 18:11:33', $posts[97]->getPublishedAt()->format('Y-m-d H:i:s'));
    }
